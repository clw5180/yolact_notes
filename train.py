...
parser.add_argument('--num_workers', default=0, type=int,  # clw modify: for windows
...
parser.add_argument('--config', default='pear_config', help='The config object to use.')  # clw modify
...
def train():
    ...
    epoch_size = len(dataset) // args.batch_size # clw note：注意如果数据集特别小而batchsize很大，那么epoch_size可能为0，那么下一步就会报错
    ...
    try:
        ...
        if args.interrupt:
            ...
            #SavePath.remove_interrupt(args.save_folder)   # clw delete
